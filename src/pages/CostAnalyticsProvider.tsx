...
// Add this useEffect to load cached storage results when the menu is selected
  ...
  const fetchCostAnalytics = async () => {
    ...
    .filter((service: ServiceBreakdown) => service.amount > 0.50)
    .filter((service: ServiceBreakdown) => service.percentage > 0.5)
    .slice(0, 10);
...
{!["overview", "connect", "breakdown", "services", "resources", "github", "deployments", "forecast", "rightsizing", "storage", "idle"].includes(selectedMenu) && (
              <Card>
                <div className="text-center py-12">
